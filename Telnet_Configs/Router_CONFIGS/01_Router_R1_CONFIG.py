...
tn.write(b"network 10.0.1.1 0.0.0.0\n")
tn.write(b"network 172.16.40.1 0.0.0.0\n")
tn.write(b"network 172.16.20.2 0.0.0.0\n")
tn.write(b"network 1.1.1.1 0.0.0.0\n")
tn.write(b"passive-interface e0/0\n")
tn.write(b"passive-interface e0/1\n")
tn.write(b"eigrp router-id 1.1.1.1\n")
tn.write(b"no auto-summary\n")
tn.write(b"no shutdown\n")
tn.write(b"exit\n")
##### Configure OSPF
tn.write(b"router ospf 110\n")
tn.write(b"network 10.0.1.1 0.0.0.0 area 0\n")
tn.write(b"network 172.16.10.1 0.0.0.0 area 0\n")
